...
donors = u_reduced.select_atoms('(type N or type O) and (resname ARG or resname ASN or resname ASP or resname CYS or resname GLN or resname GLU or resname HIS or resname LYS or resname SER or resname THR or resname TRP or resname TYR)')
acceptors = u_reduced.select_atoms('type O or type N')

# %%
# Perform hydrogen bond analysis
hba = hbonds.HydrogenBondAnalysis(u_reduced, donors_sel=donors, hydrogens_sel=hydrogens, acceptors_sel=acceptors)
hba.run()
# %%
