...
#%%
# Set dir path
path = '/home/pghw87/Documents/md-sim/5ue6/trimer/trimer'
...
u = mda.Universe('data/5ue6_newbox.gro', 'final_1000/md_center.xtc')
ref = mda.Universe('data/5ue6_newbox.gro', 'final_1000/md_center.xtc')
...
aligner = align.AlignTraj(u, ref, select='protein',
                           filename='final_1000/aligned_1000.xtc').run()
#%%
# Load the aligned trajectory and calculate rmsd
u_aligned = mda.Universe('data/5ue6_newbox.gro', 'final_1000/aligned_1000.xtc')
ref_aligned = mda.Universe('data/5ue6_newbox.gro', 'final_1000/aligned_1000.xtc')
...
ax.set_title("RMSD of the aligned Protein")
# %%
# Calculate RMSF
...
u_strided = mda.Universe('data/5ue6_newbox.gro', 'final_1000/aligned_1000.xtc', stride=20)
